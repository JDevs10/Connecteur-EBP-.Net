...
namespace ConnecteurEBP.Utilities
{
  ...
  public static class CommandLinesHelper
  {
    ...
    public static string ImportDelivery
    {
        get
        {
			return string.Format("{0} {1} {2}", DatabaseCommandLine, Gui, "/Import=\"{0}\";SaleDelivery;Import_BonLivraison");
        }
    }
      /// <summary>
    ...
    public static string ImportFactures
    {
        get
        {
            return string.Format("{0} {1} {2}", DatabaseCommandLine, Gui, "/Import=\"{0}\";SaleInvoices;Import_facture");
        }
    }
