...
namespace ConnecteurEBP.Classes
{
    public class Client
    {
        ...
        public Client(string sCliCode, string sCliRaisonSoc, string sCliAdresse1Ligne, string sCliAdresse1CodePos, string sCliAdresse1Ville, string sCliAdresse1CodePay, string sCli_Adresse1_NPAI, string sCliAdresse2Ligne, string sCliAdresse2CodePos, string sCliAdresse2Ville
            , string sCliAdresse2CodePay, string sCli_Adresse2_NPAI, string sCliType, string sCliNII, string sCliFraisPort, string sCliModeReglement, string sCliEscompte, string sCliRemise, string bRemiseTTC, string sCliDevise, string sCliCivilite, string sCliExemplairesPiec
            , string sCli_NoCompte, string sCli_CodeRepr, string sCli_GrilleTarifs, string sCli_ModeleDevis0, string sCli_ModeleDevis1, string sCli_ModeleCommande0, string sCli_ModeleCommande1, string sCli_ModeleBL0, string sCli_ModeleBL1, string sCli_ModeleFacture0
            , string sCli_ModeleFacture1, string sCli_DepotDefaut, string sCli_LienExterne, string sCli_Escompte, string sCli_RemiseProduits, string sCli_RemiseServices, string sCli_RemiseForfaits, string sCli_Siret, string codebarcf, string sCondRegl_NbJours, string sCondReglEchNbJour1
            , string sCondReglEchNbJour2, string sCondReglEchNbJour3, string sCondReglEchNbJour4, string sCondReglEchNbJour5, string sCondReglEchNbJour6, string sCondReglEchNbJour7, string sCondReglEchNbJour8, string sCondReglEchNbJour9, string sCondRegl_Net, string sCondReglEchTypeEc1
            , string sCondReglEchTypeEc2, string sCondReglEchTypeEc3, string sCondReglEchTypeEc4, string sCondReglEchTypeEc5, string sCondReglEchTypeEc6, string sCondReglEchTypeEc7, string sCondReglEchTypeEc8, string sCondReglEchTypeEc9, string sCondRegl_JourLe
            , string sCondRegl_JourLe1, string sCondRegl_JourLe2, string sCondRegl_JourLe3, string sCondRegl_JourLe4, string sCondRegl_JourLe5, string sCondRegl_JourLe6, string sCondRegl_JourLe7, string sCondRegl_JourLe8, string sCondRegl_JourLe9, string sCondReglEchPource0
            , string sCondReglEchPource1, string sCondReglEchPource2, string sCondReglEchPource3, string sCondReglEchPource4, string sCondReglEchPource5, string sCondReglEchPource6, string sCondReglEchPource7, string sCondReglEchPource8, string sCondReglEchPource9, string b30jEquivalentMois, string sCondReglEchb30jEq1
            , string sCondReglEchb30jEq2, string sCondReglEchb30jEq3, string sCondReglEchb30jEq4, string sCondReglEchb30jEq5, string sCondReglEchb30jEq6, string sCondReglEchb30jEq7, string sCondReglEchb30jEq8, string sCondReglEchb30jEq9)
        {
