...
namespace ConnecteurEBP.Classes
{
    public class ClientExport
    {
        ...
        public ClientExport(string sCliCode,string CodeBarCF,string sCliRaisonSoc,string sCliAdresse1Ligne,string sCliAdresse1CodePos,string sCliAdresse1Ville,string sCliAdresse1CodePay,string sCli_Adresse1_NPAI,string sCliAdresse2Ligne,string sCliAdresse2CodePos,string sCliAdresse2Ville,
                            string sCliAdresse2CodePay,string sCli_Adresse2_NPAI,string sCliType,string sCliFraisPort,string sCliModeReglement,string sCliDevise,string sCliCivilite,string sCli_NoCompte,string sCli_CodeRepr,string sCli_GrilleTarifs,string sCli_LienExterne,
                            string sCli_siret,string BIC0_Banque,string BIC0_Pays,string BIC0_Localication,string BIC0_Branche,string IBAN0_Pays,string IBAN0_Controle,string IBAN0_Contenu,string Bq0NomBanque,string Bq0AdrBanque,string CB0_AdresseSuite,string BIC1_Banque,string BIC1_Pays,
                            string BIC1_Localication,string BIC1_Branche,string IBAN1_Pays,string IBAN1_Controle,string IBAN1_Contenu,string Bq1NomBanque,string Bq1AdrBanque,string CB1_AdresseSuite,string BIC2_Banque,string BIC2_Pays,string BIC2_Localication,string BIC2_Branche,
                            string IBAN2_Pays,string IBAN2_Controle,string IBAN2_Contenu,string Bq2NomBanque,string Bq2AdrBanque,string CB2_AdresseSuite,string BIC3_Banque,string BIC3_Pays,string BIC3_Localication,string BIC3_Branche,string IBAN3_Pays,string IBAN3_Controle,
                            string IBAN3_Contenu,string Bq3NomBanque,string Bq3AdrBanque,string CB3_AdresseSuite)
        {
